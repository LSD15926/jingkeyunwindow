...
namespace Sunny.UI
{
    public class MyPagination : UIPanel, ITranslate
    {
        ...
        private UIComboBox comPageSize;
        ...
        public MyPagination()
        {
            ...
            for (var i = 0; i < 17; i++)
            {
                if (!buttonTags.ContainsKey(buttons[i]))
        ...
        private void changePostion()
        {
            ...
            uiLabel1.Location = new Point(b16.Location.X+90,10);
            edtPage.Location = new Point(uiLabel1.Location.X + 23, 3);
            uiLabel2.Location = new Point(uiLabel1.Location.X + 76, 10);
            btnSelect.Location = new Point(uiLabel2.Location.X + 30, 3);
            comPageSize.Location=new Point(btnSelect.Location.X+80, 3);
        }
        public static int Mod(int value, int divParam)
        {
        ...
        private void UIDataGridPage_Click(object sender, EventArgs e)
        {
            ...
            btn.BringToFront();
            if (!string.IsNullOrEmpty(btn.TagString))
        ...
        private void InitializeComponent()
        {
            ...
            this.comPageSize = new Sunny.UI.UIComboBox();
            this.SuspendLayout();
            // 
            // b0
            // 
            ...
            this.edtPage.Location = new System.Drawing.Point(673, 3);
            ...
            this.edtPage.Watermark = "";
            // 
            // btnSelect
            // 
            this.btnSelect.Cursor = System.Windows.Forms.Cursors.Hand;
            this.btnSelect.Font = new System.Drawing.Font("宋体", 10.5F);
            this.btnSelect.Location = new System.Drawing.Point(756, 3);
            ...
            this.uiLabel2.Location = new System.Drawing.Point(726, 10);
            this.uiLabel2.Name = "uiLabel2";
            this.uiLabel2.Size = new System.Drawing.Size(21, 14);
            ...
            this.uiLabel1.Location = new System.Drawing.Point(650, 10);
            this.uiLabel1.Name = "uiLabel1";
            this.uiLabel1.Size = new System.Drawing.Size(21, 14);
        ...
        private void SetShowButtons()
        {
            ...
            PageCount = Mod(TotalCount,PageSize) == 0 ? TotalCount / PageSize : TotalCount / PageSize + 1;
        ...
        {
            if (comPageSize.SelectedIndex >= 0)
                PageSize = (int)(comPageSize.SelectedItem as ComboBoxItem).Value;
        }
    }
}