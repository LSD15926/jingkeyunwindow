...
{
    public partial class EditCat : UIForm
    {
        ...
        public GoodListResponse GoodsModel
        {
            ...
            set
            {
                ...
                GetCats(uiTreeView1);
                uiLabel2.Text = value.goods_name;
            }
        }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            model.goods_id = _GoodsModel.goods_id;
            model.cat_id = cat.cat_id;
            model.Malls = _GoodsModel.Mallinfo;
            models.Add(model);

            InitUser.RunningTask.Add("单商品分类" + stampNow, stampNow.ToString());
        ...
        {
            InitUser.RunningTask.Remove("单商品分类" + stampNow);
        ...
        {
            RequstCat requstCat = new RequstCat(cat_id, _GoodsModel.Mallinfo);
